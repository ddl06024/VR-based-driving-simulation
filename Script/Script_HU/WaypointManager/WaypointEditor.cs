...
public class WaypointEditor
{
    ...
    public static void OnDrawSceneGizmo(Waypointer waypoint, GizmoType gizmoType)
    {
        ...
        Waypointer waypo = waypoint.GetComponent<Waypointer>();
        


        if (waypoint.previousWaypoint != null && (waypo.tag == "Pedestrians" || waypo.tag == "Untagged"))
        {
        ...
        if (waypoint.nextWaypoint != null && (waypo.tag == "Pedestrians" || waypo.tag == "Untagged"))
        {
        ...
        {
            foreach (Waypointer branch in waypoint.branches)
            {
        ...
        {
            foreach (Waypointer branch1 in waypoint.branches1)
            {
