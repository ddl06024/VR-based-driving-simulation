...
public class Waypointer_hj : MonoBehaviour
{
    public Waypointer_hj previousWaypoint;
    public Waypointer_hj nextWaypoint;
    ...
    public List<Waypointer_hj> branches = new List<Waypointer_hj>();

    [Range(0f, 5f)]
    public float branchRatio = 0.5f;

    public List<Waypointer_hj> branches1 = new List<Waypointer_hj>();
